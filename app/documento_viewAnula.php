...
?>
<br>
<form action="documento_viewAnula1.php" method="post" name="form1">
...
va;
				...
				<tr>
				  <td colspan="3" align="center">
				    <table border="0">
					  <tr>
					    <td>Motivo / Observacion:</td>
						<td>
						  <textarea name="tObservacion" cols="80" rows="5"></textarea>
						</td>
						<td>
						  <input type="submit" name="bAnular" value="Anular">
