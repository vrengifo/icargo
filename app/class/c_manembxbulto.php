...
class c_manembxbulto
{
  ...
  function c_manembxbulto($conDb,$usuario)
  {
	  $this->manemb_id="";
  ...
  */
  ...
  {
	echo "<hr>Class c_manembxbulto(conDb,$this->usu_audit)<br>";
  ...
  function existe($vid)
  {
  	$oAux=new c_manembxbulto($this->con,$this->usu_audit);
...
va;
  ...
  function update($id)
  {
	...
	if($existe!="0")
	{
	  $oAux=new c_manembxbulto($this->con);
	  $oAux->cad2id($id);
...
va;
  ...
  function sqlSelect()
  {
    $oAux=new c_manembxbulto($this->con,$this->usu_audit);
    $cadId=$oAux->armarSqlId("","");
  	$cad="select $cadId a1,$cadId a2 from manembxbulto order by a1";
    return($cad);
  }
