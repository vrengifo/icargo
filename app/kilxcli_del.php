<?php 
  ...
  include('class/c_kiloequivalenciaxcli.php'); 

  extract($_REQUEST);		

  $cait=new c_kiloequivalenciaxcli($conn,$sUsername);
  ...
  */
  ...
  $param="principal=".$principal."&id_aplicacion=".$id_aplicacion."&id_subaplicacion=".$id_subaplicacion."&padre=".$padre;
  
  $destino="location:kiloequixcli.php?".$param;
