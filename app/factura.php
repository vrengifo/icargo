...
<form action="factura1.php" method="post" name="form1">
		...
		<table width="100%" border=0 cellspacing=0 cellpadding=0 CLASS="titletable">
		  <tr>							
            <td nowrap><SPAN class="title" STYLE="cursor:default;"> 
                          ...
                          Factura Nro. <input name="gui_nro" type="text" value="<?=$gui_nro?>" size="8" maxlength="7"></font></SPAN>
			</td>
		  </tr>
		</table>
                      ...
                      <table width="100%" border="1">
                        ...
                        <tr> 
                          <td> 
                            ...
                            <input name="hora" type="text" size="5" maxlength="5" value="<?=$vvhora?>"> 
                          </td>
                  ...
                  <td width="45%" nowrap  bgcolor='#ffffff'> <table width="100%" border="1">
                      ...
                      <tr> 
                        ...
                        <td width="15%">
                          ...
                          <!--<input name="validarci" type="button" value="Verificar CI/RUC" onClick="return valida_ci(document.form1.remite_ciruc.value);">-->
						</td>
                      </tr>
                      <tr> 
                        <td>Dirección</td>
                        ...
                        <td colspan="2"><table width="100%" border="1">
                            <tr> 
                              ...
                              <td class="table_hd"><p>CONTADO 
                                  <input name="tipgui_id" type="radio" value="PR" checked>
                                </p>
                                <p>COLLECT 
