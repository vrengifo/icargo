...
?>
<br>
<form action="documento_entregar1.php" method="post" name="form1">
...
va;
				...
				<tr>
				  ...
				  <?php
				      $cad="onclick=\"fOpenWindow('documentoPdf.php?id=".$id."&usua=".$sUsername."','AddCliente','400','400')\"";
				  ?>				    
				    <input type="button" name="imprimir" value="Imprimir" <?=$cad?>>
				    <input type="submit" name="Entregar" value="Entregar Documento" >
				  </td>
				</tr>                
              </table></TABLE>
				  </TABLE>
