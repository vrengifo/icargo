...
function valida() {
	...
	<?php
		...
		$campo=array(
						array("etiqueta"=>"* Módulo","nombre"=>"clp0","tipo_campo"=>"select","sql"=>$sql_mod,"valor"=>$v_id_aplicacion),
						array("etiqueta"=>"* Submódulo","nombre"=>"clp1","tipo_campo"=>"text","sql"=>"","valor"=>$vnombre),
