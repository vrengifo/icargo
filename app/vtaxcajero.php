...
function valida() {
	...
	<br>
	<form action="vtaxcajero.php" method="post" name="form1">
	<?php
...
va;
						  //echo($cadUrl);
						  echo "Documento listo para entregar";
                        }
                        else 
                          echo("Documento incompleto, faltan paquetes para efectuar entrega");	
                      }
                      if($vestado=="E")
                      {
