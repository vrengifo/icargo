...
<HTML><HEAD><TITLE>ARIA Login</TITLE>
      ...
      <TABLE border=0 cellPadding=10 cellSpacing=0 width="100%">
        ...
        <TR>
          <TD height=330>
            ...
            <table><tr><td>
                        <B><FONT FACE="Arial,Helvetica,sans-serif" SIZE="-1" COLOR="#000000">Login: </FONT></B></td>
                        <td><INPUT TYPE="text" NAME="entered_login" STYLE="font-size: 9pt;" TABINDEX="1"><br></td></tr>
                        <tr><td><B><FONT FACE="Arial,Helvetica,sans-serif" SIZE="-1" COLOR="#000000">Password: </FONT></B> </td>
...
<TABLE WIDTH="100%" HEIGHT="100%" CELLPADDING="0" CELLSPACING="0"><TR><TD ALIGN="center" VALIGN="middle">
        ...
        <TABLE <?PHP echo $theTable; ?> CELLPADDING="0" CELLSPACING="0" BACKGROUND="authentication/images/<?PHP echo $bgImage; ?>"><TR><TD ALIGN="center" ALIGN="middle">
                ...
                <td ALIGN="left" VALIGN="bottom">
                        ...
                        <TR><TD ALIGN="left" COLSPAN="2"><h1><font COLOR="#000000">Login</font></h1></TD></TR>
                        <tr><td><B><FONT FACE="Arial,Helvetica,sans-serif" SIZE="<h2>" COLOR="#000000">Login: </FONT></B></td>
                        <td> <INPUT TYPE="text" NAME="entered_login" STYLE="font-size: 12pt;" TABINDEX="1"></td></tr>
                        <tr><td><B><FONT FACE="Arial,Helvetica,sans-serif" SIZE="<h2>" COLOR="#000000">Password: </FONT></B></td>
