...
function valida() {
	...
	<br>
	<form action="desembarque3.php" method="post" name="form1">
	<?php						
		$campo=array(
...
<br>			
	...
	<TR><TD>
			...
			<TR><TD>
                ...
                <?php
						$tpiezas=0;
						$tpeso=0;
						$sql="select g.gui_nro,g.gui_piezas,g.gui_peso,g.gui_destinatario,g.gui_id "
                ...
                <TR valign=top bgcolor='#ffffff'> 
                  <TD valign=top nowrap>
				    <input type="checkbox" name="chc[<?=$cont?>]" value="<?=$gui_id?>"> 
					<input type="hidden" name="guia[<?=$cont?>]" value="<?=$gui_id?>">
                  </TD>
                  <TD valign=top nowrap> 
                    <?=$gui_nro?>
                    &nbsp;</TD>
  ...
  <input type="submit" name="siguiente" value="Siguiente (Generar Manifiesto de Desembarque)">
