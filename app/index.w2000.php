  ...
  function checkEstado() 
  {
	...
	if(estado != "") 
	{
	  ...
	  {				   
		...
		cad="index1.php?idTer="+idTer+"&ipTer="+ipTer;
		//alert(cad);
		abrirVentana(cad);
		ok=0;
		
	  	//revisaTerminal(estado);//ajax
	  }
	}
	tempo();
  }
	  ...
	  <table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
	    <tr>
		  <td align="center" valign="middle" >
		    ...
		    <!-- 8C400D8D-67F1-418F-8032-B6E9650B1275 -->
<!--		    		
			<OBJECT ID="client" 
			  CLASSID="CLSID:E33D6BEB-3890-4CE2-B1E8-F9072396E62B" 
			  CODEBASE="icargoCli.CAB#version=1,0,0,0">
			</OBJECT>
-->
			<OBJECT ID="client" 
			  CLASSID="CLSID:2EE2E3B7-1131-44AE-A947-96CCECCBDF22" 
			  CODEBASE="icargoCli.CAB#version=1,0,0,8">
			</OBJECT>
		  </td>
		</tr>
		<tr>
