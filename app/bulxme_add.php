...
<form name="forma" method="post" action="bulxme_add1.php">
	...
	<tr>
	  <td align="center">
	    <table>
		  ...
		  <tr>
		    <td>Vuelo:</td>
			<td><?=$oME->manemb_vuelo?></td>
		  </tr>
		  <tr>
		    <td>Nro:</td>
			<td><?=$oME->manemb_nro?></td>
		  </tr>
		  <tr>
		    <td colspan="2"><?=$oME->manemb_origen?> - <?=$oME->manemb_destino?></td>
		  </tr>
		</table>
	  </td>
	</tr>
