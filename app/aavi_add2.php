...
function valida() {
	...
	<?php				
		...
		$campo=array(
						...
						array("etiqueta"=>"* Peso Máximo","nombre"=>"clp2","tipo_campo"=>"text","sql"=>"","valor"=>$vpesomax),
						array("etiqueta"=>"* Volumen Máximo","nombre"=>"clp3","tipo_campo"=>"text","sql"=>"","valor"=>$vvolmax)
					);
		...
		build_upd($conn,'false',"Avión","images/360/memowrite.gif","50%",'true'
